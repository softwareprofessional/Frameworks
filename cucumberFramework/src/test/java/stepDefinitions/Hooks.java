...
public class Hooks {
	...
	public void BeforeSteps() {
		 ...
		 */
		Reporter.assignAuthor("Reporter - Sarayu Sahaj");

		/*
		 * Or if you know what all scenarios are written by whom, you can create a logic
		 * around like this:
		 * 
		 * Java
		 * 
		 * @Before public void beforeScenario(Scenario scenario) { if
		 * (scenario.getName().equals("Some scenario name")) {
		 * Reporter.assignAuthor("ToolsQA - Lakshay Sharma"); } Or if you know what all
		 * scenarios are written by whom, you can create a logic around like this:
		 * 
		 * @Before public void beforeScenario(Scenario scenario) { if
		 * (scenario.getName().equals("Some scenario name")) {
